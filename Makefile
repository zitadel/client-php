...
# subsequent format-check is a no-op. Rector applies the repo's rector.php
# transforms (e.g. string class-names to ::class) and php-cs-fixer then
# normalizes style per the repo's .php-cs-fixer.dist.php.
format:
