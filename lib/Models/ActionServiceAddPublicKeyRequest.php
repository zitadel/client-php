...
class ActionServiceAddPublicKeyRequest
{
    ...
    /**
     * 2.1 — Returns the raw decoded bytes for the `publicKey`
     ...
     */
    public function getPublicKeyAsBytes(): ?string
    {
        return \Zitadel\Client\ObjectSerializer::decodeBytes($this->publicKey);
    }

    /**
     * 2.1 — Stores raw bytes in the `publicKey` field (OAS
     ...
     */
    public function setPublicKeyFromBytes(?string $raw): void
    {
