...
class UserServiceAddKeyResponse
{
    ...
    /**
     * 2.1 — Returns the raw decoded bytes for the `keyContent`
     ...
     */
    public function getKeyContentAsBytes(): ?string
    {
        return \Zitadel\Client\ObjectSerializer::decodeBytes($this->keyContent);
    }

    /**
     * 2.1 — Stores raw bytes in the `keyContent` field (OAS
     ...
     */
    public function setKeyContentFromBytes(?string $raw): void
    {
        $encoded = \Zitadel\Client\ObjectSerializer::encodeBytes($raw);
        if ($encoded !== null) {
            $this->keyContent = $encoded;
        }
    }
}
