        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\Zitadel\Client\Model\OrganizationServiceAddOrganizationResponse', $this->config, []),
                ...
                case 403:
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\Zitadel\Client\Model\OrganizationServiceRpcStatus', $this->config, []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                case 404:
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\Zitadel\Client\Model\OrganizationServiceListOrganizationsResponse', $this->config, []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                case 400:
