        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\Zitadel\Client\Model\SettingsServiceGetSecuritySettingsResponse', $this->config, []),
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\Zitadel\Client\Model\SettingsServiceSetSecuritySettingsResponse', $this->config, []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                case 403:
