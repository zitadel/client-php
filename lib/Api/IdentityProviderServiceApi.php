        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\Zitadel\Client\Model\IdentityProviderServiceGetIDPByIDResponse', $this->config, []),
                ...
                case 403:
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\Zitadel\Client\Model\IdentityProviderServiceRpcStatus', $this->config, []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                case 404:
