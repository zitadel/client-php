        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\Zitadel\Client\Model\SAMLServiceCreateResponseResponse', $this->config, []),
                ...
                case 403:
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\Zitadel\Client\Model\SAMLServiceRpcStatus', $this->config, []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                case 404:
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\Zitadel\Client\Model\SAMLServiceGetSAMLRequestResponse', $this->config, []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                case 403:
