...
class BetaOrganizationServiceApi
{
     ...
     *
     * @return \Zitadel\Client\Model\BetaOrganizationServiceAddOrganizationResponse
     * @throws ApiException
     */
    public function addOrganization($betaOrganizationServiceAddOrganizationRequest, string $contentType = self::contentTypes['addOrganization'][0])
    {
        ...
        $responseTypes = [
            200 => '\Zitadel\Client\Model\BetaOrganizationServiceAddOrganizationResponse',
            'default' => '\Zitadel\Client\Model\BetaOrganizationServiceConnectError',
        ];
        $defaultSignatureType = '\Zitadel\Client\Model\BetaOrganizationServiceAddOrganizationResponse';
     ...
     */
    private function addOrganizationRequest($betaOrganizationServiceAddOrganizationRequest, string $contentType = self::contentTypes['addOrganization'][0])
    {
