...
class BetaOIDCServiceApi
{
    ...
    public function createCallback($betaOIDCServiceCreateCallbackRequest, string $contentType = self::contentTypes['createCallback'][0])
    {
        ...
        $responseTypes = [
            200 => '\Zitadel\Client\Model\BetaOIDCServiceCreateCallbackResponse',
            'default' => '\Zitadel\Client\Model\BetaOIDCServiceConnectError',
        ];
        $defaultSignatureType = '\Zitadel\Client\Model\BetaOIDCServiceCreateCallbackResponse';
     ...
     */
    private function createCallbackRequest($betaOIDCServiceCreateCallbackRequest, string $contentType = self::contentTypes['createCallback'][0])
    {
     ...
     *
     * @return \Zitadel\Client\Model\BetaOIDCServiceGetAuthRequestResponse
     * @throws ApiException
     */
    public function getAuthRequest($betaOIDCServiceGetAuthRequestRequest, string $contentType = self::contentTypes['getAuthRequest'][0])
    {
        ...
        $responseTypes = [
            200 => '\Zitadel\Client\Model\BetaOIDCServiceGetAuthRequestResponse',
            'default' => '\Zitadel\Client\Model\BetaOIDCServiceConnectError',
        ];
        $defaultSignatureType = '\Zitadel\Client\Model\BetaOIDCServiceGetAuthRequestResponse';
        return $this->executeRequest($request, $responseTypes, $defaultSignatureType);
    }
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    private function getAuthRequestRequest($betaOIDCServiceGetAuthRequestRequest, string $contentType = self::contentTypes['getAuthRequest'][0])
    {
