...
class BetaOIDCServiceApi
{
     ...
     *
     * @return \Zitadel\Client\Model\NoOp200Response15
     * @throws ApiException
     */
    public function noOp(string $contentType = self::contentTypes['noOp'][0])
    {
        ...
        $responseTypes = [
            200 => '\Zitadel\Client\Model\NoOp200Response15',
        ];
        $defaultSignatureType = '\Zitadel\Client\Model\NoOp200Response15';
        return $this->executeRequest($request, $responseTypes, $defaultSignatureType);
    }
