...
class SessionServiceSearchQuery implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['creationDateQuery'] === null) {
            $invalidProperties[] = "'creationDateQuery' can't be null";
        }
        if ($this->container['creatorQuery'] === null) {
            $invalidProperties[] = "'creatorQuery' can't be null";
        }
        if ($this->container['idsQuery'] === null) {
            $invalidProperties[] = "'idsQuery' can't be null";
        }
        if ($this->container['userAgentQuery'] === null) {
            $invalidProperties[] = "'userAgentQuery' can't be null";
        }
        if ($this->container['userIdQuery'] === null) {
            $invalidProperties[] = "'userIdQuery' can't be null";
        }
     ...
     *
     * @return \Zitadel\Client\Model\SessionServiceCreationDateQuery
     */
     ...
     *
     * @param \Zitadel\Client\Model\SessionServiceCreationDateQuery $creationDateQuery creationDateQuery
     *
     * @return self
     */
     ...
     * Gets creatorQuery
     *
     * @return \Zitadel\Client\Model\SessionServiceCreatorQuery
     */
     ...
     * Sets creatorQuery
     *
     * @param \Zitadel\Client\Model\SessionServiceCreatorQuery $creatorQuery creatorQuery
     *
     * @return self
     */
     ...
     * Gets idsQuery
     *
     * @return \Zitadel\Client\Model\SessionServiceIDsQuery
     */
     ...
     * Sets idsQuery
     *
     * @param \Zitadel\Client\Model\SessionServiceIDsQuery $idsQuery idsQuery
     *
     * @return self
     */
     ...
     * Gets userAgentQuery
     *
     * @return \Zitadel\Client\Model\SessionServiceUserAgentQuery
     */
     ...
     * Sets userAgentQuery
     *
     * @param \Zitadel\Client\Model\SessionServiceUserAgentQuery $userAgentQuery userAgentQuery
     *
     * @return self
     */
     ...
     * Gets userIdQuery
     *
     * @return \Zitadel\Client\Model\SessionServiceUserIDQuery
     */
     ...
     * Sets userIdQuery
     *
     * @param \Zitadel\Client\Model\SessionServiceUserIDQuery $userIdQuery userIdQuery
     *
     * @return self
     */
