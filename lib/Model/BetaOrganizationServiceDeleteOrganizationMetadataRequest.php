...
/**
 * BetaOrganizationServiceDeleteOrganizationMetadataRequest Class Doc Comment
 *
 * @category Class
 * @package  Zitadel\Client
 * @author   OpenAPI Generator team
 ...
 */
class BetaOrganizationServiceDeleteOrganizationMetadataRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'BetaOrganizationServiceDeleteOrganizationMetadataRequest';
    ...
    */
     ...
     * Sets keys
     *
     * @param string[]|null $keys The keys for the Organization metadata to be deleted.
     *
     * @return self
     */
