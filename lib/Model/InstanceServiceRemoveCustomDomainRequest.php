...
/**
 * InstanceServiceRemoveCustomDomainRequest Class Doc Comment
 *
 * @category Class
 * @package  Zitadel\Client
 * @author   OpenAPI Generator team
 ...
 */
class InstanceServiceRemoveCustomDomainRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'InstanceServiceRemoveCustomDomainRequest';
    ...
    */
     ...
     * Sets instanceId
     *
     * @param string|null $instanceId InstanceID is the unique ID of the instance from which the domain will be removed.
     *
     * @return self
     */
     ...
     * Sets customDomain
     *
     * @param string|null $customDomain CustomDomain is the the domain to remove from the instance.
     *
     * @return self
     */
