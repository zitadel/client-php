    ...
    */
    ...
    public function setOrganizationId($organizationId)
    {
        ...
        if ((mb_strlen($organizationId) > 200)) {
            throw new \InvalidArgumentException('invalid length for $organizationId when calling V2OrganizationIdQuery., must be smaller than or equal to 200.');
        }
        if ((mb_strlen($organizationId) < 1)) {
            throw new \InvalidArgumentException('invalid length for $organizationId when calling V2OrganizationIdQuery., must be bigger than or equal to 1.');
        }
