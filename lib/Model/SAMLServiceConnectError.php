...
/**
 * SAMLServiceConnectError Class Doc Comment
 *
 * @category Class
 ...
 */
class SAMLServiceConnectError implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'SAMLServiceConnectError';
    ...
    protected static $openAPITypes = [
        'code' => 'string',
        'message' => 'string',
        'details' => '\Zitadel\Client\Model\SAMLServiceAny[]'
    ];
    ...
    */
     ...
     * Gets details
     *
     * @return \Zitadel\Client\Model\SAMLServiceAny[]|null
     */
     ...
     * Sets details
     *
     * @param \Zitadel\Client\Model\SAMLServiceAny[]|null $details A list of messages that carry the error details. There is no limit on the number of messages.
     *
     * @return self
     */
