...
/**
 * BetaWebKeyServiceWebKey Class Doc Comment
 *
 * @category Class
 * @package  Zitadel\Client
 * @author   OpenAPI Generator team
 ...
 */
class BetaWebKeyServiceWebKey implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'BetaWebKeyServiceWebKey';
    ...
    protected static $openAPITypes = [
        ...
        'changeDate' => '\DateTime',
        'state' => '\Zitadel\Client\Model\BetaWebKeyServiceState',
        'ecdsa' => '\Zitadel\Client\Model\BetaWebKeyServiceECDSA',
        'ed25519' => 'object',
        'rsa' => '\Zitadel\Client\Model\BetaWebKeyServiceRSA'
    ];
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['ecdsa'] === null) {
            $invalidProperties[] = "'ecdsa' can't be null";
        }
        if ($this->container['ed25519'] === null) {
            $invalidProperties[] = "'ed25519' can't be null";
        }
        if ($this->container['rsa'] === null) {
            $invalidProperties[] = "'rsa' can't be null";
        }
     ...
     * Sets id
     *
     * @param string|null $id The unique identifier of the key.
     *
     * @return self
     */
     ...
     * Gets state
     *
     * @return \Zitadel\Client\Model\BetaWebKeyServiceState|null
     */
     ...
     * Sets state
     *
     * @param \Zitadel\Client\Model\BetaWebKeyServiceState|null $state state
     *
     * @return self
     */
     ...
     * Gets ecdsa
     *
     * @return \Zitadel\Client\Model\BetaWebKeyServiceECDSA
     */
     ...
     * Sets ecdsa
     *
     * @param \Zitadel\Client\Model\BetaWebKeyServiceECDSA $ecdsa ecdsa
     *
     * @return self
     */
     ...
     * Gets rsa
     *
     * @return \Zitadel\Client\Model\BetaWebKeyServiceRSA
     */
     ...
     * Sets rsa
     *
     * @param \Zitadel\Client\Model\BetaWebKeyServiceRSA $rsa rsa
     *
     * @return self
     */
