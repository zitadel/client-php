...
/**
 * InstanceServiceCustomDomain Class Doc Comment
 *
 * @category Class
 * @package  Zitadel\Client
 * @author   OpenAPI Generator team
 ...
 */
class InstanceServiceCustomDomain implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'InstanceServiceCustomDomain';
    ...
    */
     ...
     * Sets instanceId
     *
     * @param string|null $instanceId InstanceID is the unique identifier of the instance the domain belongs to.
     *
     * @return self
     */
     ...
     * Sets domain
     *
     * @param string|null $domain Domain is the fully qualified domain name.  It must be unique across all instances in the system.
     *
     * @return self
     */
     ...
     * Sets primary
     *
     * @param bool|null $primary Primary states whether this domain is the primary domain of the instance.  Each instance must have exactly one primary domain.  The primary domain is used for various purposes and acts as fallback  in those cases, e.g if no explicit domain is specified.
     *
     * @return self
     */
     ...
     * Sets generated
     *
     * @param bool|null $generated Generate states whether this domain was auto-generated by the system.  Auto-generated domains follow a specific pattern and are created  when a new instance is created.  They cannot be deleted, but the primary domain can be changed  to a manually added domain.
     *
     * @return self
     */
