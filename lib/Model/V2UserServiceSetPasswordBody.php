...
/**
 * V2UserServiceSetPasswordBody Class Doc Comment
 *
 * @category Class
 * @package  Zitadel\Client
 * @author   OpenAPI Generator team
 ...
 */
class V2UserServiceSetPasswordBody implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'v2UserServiceSetPasswordBody';
    ...
    protected static $openAPITypes = [
        'newPassword' => '\Zitadel\Client\Model\V2Password',
    ...
    */
     ...
     * Sets newPassword
     *
     * @param \Zitadel\Client\Model\V2Password|null $newPassword newPassword
     *
     * @return self
     */
    ...
    public function setCurrentPassword($currentPassword)
    {
        ...
        if ((mb_strlen($currentPassword) > 200)) {
            throw new \InvalidArgumentException('invalid length for $currentPassword when calling V2UserServiceSetPasswordBody., must be smaller than or equal to 200.');
        }
        if ((mb_strlen($currentPassword) < 1)) {
            throw new \InvalidArgumentException('invalid length for $currentPassword when calling V2UserServiceSetPasswordBody., must be bigger than or equal to 1.');
        }
    ...
    public function setVerificationCode($verificationCode)
    {
        ...
        if ((mb_strlen($verificationCode) > 20)) {
            throw new \InvalidArgumentException('invalid length for $verificationCode when calling V2UserServiceSetPasswordBody., must be smaller than or equal to 20.');
        }
        if ((mb_strlen($verificationCode) < 1)) {
            throw new \InvalidArgumentException('invalid length for $verificationCode when calling V2UserServiceSetPasswordBody., must be bigger than or equal to 1.');
        }
