...
/**
 * ProjectServiceProject Class Doc Comment
 *
 * @category Class
 * @package  Zitadel\Client
 * @author   OpenAPI Generator team
 ...
 */
class ProjectServiceProject implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ProjectServiceProject';
    ...
    protected static $openAPITypes = [
        ...
        'changeDate' => '\DateTime',
        'name' => 'string',
        'state' => '\Zitadel\Client\Model\ProjectServiceProjectState',
        'projectRoleAssertion' => 'bool',
        'authorizationRequired' => 'bool',
        'projectAccessRequired' => 'bool',
        'privateLabelingSetting' => '\Zitadel\Client\Model\ProjectServicePrivateLabelingSetting',
        'grantedOrganizationId' => 'string',
        'grantedOrganizationName' => 'string',
        'grantedState' => '\Zitadel\Client\Model\ProjectServiceGrantedProjectState'
    ];
    ...
    */
     ...
     * Sets projectId
     *
     * @param string|null $projectId ProjectID is the unique identifier of the project.
     *
     * @return self
     */
     ...
     * Sets organizationId
     *
     * @param string|null $organizationId OrganizationID is the unique identifier of the organization the project belongs to.
     *
     * @return self
     */
     ...
     * Sets name
     *
     * @param string|null $name Name is the name of the project. This might be presented to users, e.g. in sign-in flows.
     *
     * @return self
     */
     ...
     * Gets state
     *
     * @return \Zitadel\Client\Model\ProjectServiceProjectState|null
     */
     ...
     * Sets state
     *
     * @param \Zitadel\Client\Model\ProjectServiceProjectState|null $state state
     *
     * @return self
     */
     ...
     *
     * @param bool|null $projectRoleAssertion ProjectRoleAssertion is a boolean flag that describes if the roles of the user should be added to the token.
     *
     * @return self
     */
     ...
     *
     * @param bool|null $authorizationRequired AuthorizationRequired is a boolean flag that can be enabled to check if a user has  an authorization to use this project assigned when login into an application of this project.
     *
     * @return self
     */
     ...
     *
     * @param bool|null $projectAccessRequired ProjectAccessRequired is a boolean flag that can be enabled to check if the organization of the user,  that is trying to log in, has access to this project (either owns the project or is granted).
     *
     * @return self
     */
     ...
     *
     * @return \Zitadel\Client\Model\ProjectServicePrivateLabelingSetting|null
     */
     ...
     *
     * @param \Zitadel\Client\Model\ProjectServicePrivateLabelingSetting|null $privateLabelingSetting privateLabelingSetting
     *
     * @return self
     */
     ...
     *
     * @param string|null $grantedOrganizationId GrantedOrganizationID is the ID of the organization the project is granted to.  In case the project is not granted, this field is unset.
     *
     * @return self
     */
     ...
     *
     * @param string|null $grantedOrganizationName GrantedOrganizationName is the name of the organization the project is granted to.  In case the project is not granted, this field is unset.
     *
     * @return self
     */
     ...
     * Gets grantedState
     *
     * @return \Zitadel\Client\Model\ProjectServiceGrantedProjectState|null
     */
     ...
     * Sets grantedState
     *
     * @param \Zitadel\Client\Model\ProjectServiceGrantedProjectState|null $grantedState grantedState
     *
     * @return self
     */
