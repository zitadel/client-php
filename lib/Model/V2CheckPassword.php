...
/**
 * V2CheckPassword Class Doc Comment
 *
 * @category Class
 * @package  Zitadel\Client
 * @author   OpenAPI Generator team
 ...
 */
class V2CheckPassword implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'v2CheckPassword';
    ...
    */
    ...
    public function setPassword($password)
    {
        ...
        if ((mb_strlen($password) > 200)) {
            throw new \InvalidArgumentException('invalid length for $password when calling V2CheckPassword., must be smaller than or equal to 200.');
        }
        if ((mb_strlen($password) < 1)) {
            throw new \InvalidArgumentException('invalid length for $password when calling V2CheckPassword., must be bigger than or equal to 1.');
        }
