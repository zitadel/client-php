...
/**
 * ActionServiceBetaUpdateTargetResponse Class Doc Comment
 *
 * @category Class
 * @package  Zitadel\Client
 * @author   OpenAPI Generator team
 ...
 */
class ActionServiceBetaUpdateTargetResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ActionServiceBetaUpdateTargetResponse';
    ...
    */
     ...
     * Sets changeDate
     *
     * @param \DateTime|null $changeDate The timestamp of the change of the target.
     *
     * @return self
     */
