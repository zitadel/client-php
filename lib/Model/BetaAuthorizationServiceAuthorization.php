...
/**
 * BetaAuthorizationServiceAuthorization Class Doc Comment
 *
 * @category Class
 * @package  Zitadel\Client
 * @author   OpenAPI Generator team
 ...
 */
class BetaAuthorizationServiceAuthorization implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'BetaAuthorizationServiceAuthorization';
    ...
    protected static $openAPITypes = [
        ...
        'changeDate' => '\DateTime',
        'state' => '\Zitadel\Client\Model\BetaAuthorizationServiceState',
        'user' => '\Zitadel\Client\Model\BetaAuthorizationServiceUser',
        'roles' => 'string[]'
    ];
    ...
    protected static $setters = [
        ...
        'projectOrganizationId' => 'setProjectOrganizationId',
    ...
    protected static $getters = [
        ...
        'projectOrganizationId' => 'getProjectOrganizationId',
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('projectOrganizationId', $data ?? [], null);
    ...
    */
     ...
     * Sets id
     *
     * @param string|null $id ID is the unique identifier of the authorization.
     *
     * @return self
     */
     ...
     * Sets projectId
     *
     * @param string|null $projectId ID is the unique identifier of the project the user was granted the authorization for.
     *
     * @return self
     */
     ...
     * Sets projectName
     *
     * @param string|null $projectName Name is the name of the project the user was granted the authorization for.
     *
     * @return self
     */
    ...
    /**
     * Gets projectOrganizationId
     *
     * @return string|null
     */
    public function getProjectOrganizationId()
    {
        return $this->container['projectOrganizationId'];
    }

    /**
     * Sets projectOrganizationId
     *
     * @param string|null $projectOrganizationId OrganizationID is the ID of the organization the project belongs to.
     *
     * @return self
     */
    public function setProjectOrganizationId($projectOrganizationId)
    {
        if (is_null($projectOrganizationId)) {
            throw new \InvalidArgumentException('non-nullable projectOrganizationId cannot be null');
        }
        $this->container['projectOrganizationId'] = $projectOrganizationId;
     ...
     * Sets projectGrantId
     *
     * @param string|null $projectGrantId ID of the granted project, only provided if it is a granted project.
     *
     * @return self
     */
    public function setProjectGrantId($projectGrantId)
    {
        if (is_null($projectGrantId)) {
            array_push($this->openAPINullablesSetToNull, 'projectGrantId');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('projectGrantId', $nullablesSetToNull);
            if ($index !== FALSE) {
     ...
     *
     * @param string|null $grantedOrganizationId ID of the organization the project is granted to, only provided if it is a granted project.
     *
     * @return self
     */
     ...
     * Sets organizationId
     *
     * @param string|null $organizationId The unique identifier of the organization the authorization belongs to.
     *
     * @return self
     */
     ...
     * Gets state
     *
     * @return \Zitadel\Client\Model\BetaAuthorizationServiceState|null
     */
     ...
     * Sets state
     *
     * @param \Zitadel\Client\Model\BetaAuthorizationServiceState|null $state state
     *
     * @return self
     */
     ...
     * Gets user
     *
     * @return \Zitadel\Client\Model\BetaAuthorizationServiceUser|null
     */
     ...
     * Sets user
     *
     * @param \Zitadel\Client\Model\BetaAuthorizationServiceUser|null $user user
     *
     * @return self
     */
     ...
     * Sets roles
     *
     * @param string[]|null $roles Roles contains the roles the user was granted for the project.
     *
     * @return self
     */
