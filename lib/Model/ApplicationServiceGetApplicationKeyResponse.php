...
/**
 * ApplicationServiceGetApplicationKeyResponse Class Doc Comment
 *
 * @category Class
 * @package  Zitadel\Client
 * @author   OpenAPI Generator team
 ...
 */
class ApplicationServiceGetApplicationKeyResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ApplicationServiceGetApplicationKeyResponse';
    ...
    */
     ...
     * Sets keyId
     *
     * @param string|null $keyId Unique ID of the application key.
     *
     * @return self
     */
