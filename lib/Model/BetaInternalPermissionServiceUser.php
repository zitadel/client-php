...
/**
 * BetaInternalPermissionServiceUser Class Doc Comment
 *
 * @category Class
 * @package  Zitadel\Client
 * @author   OpenAPI Generator team
 ...
 */
class BetaInternalPermissionServiceUser implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'BetaInternalPermissionServiceUser';
    ...
    */
     ...
     * Sets id
     *
     * @param string|null $id ID is the unique identifier of the user.
     *
     * @return self
     */
     ...
     *
     * @param string|null $preferredLoginName PreferredLoginName is the preferred login name of the user. This value is unique across the whole instance.
     *
     * @return self
     */
     ...
     * Sets displayName
     *
     * @param string|null $displayName DisplayName is the public display name of the user.  By default it's the user's given name and family name, their username or their email address.
     *
     * @return self
     */
     ...
     * Sets organizationId
     *
     * @param string|null $organizationId The organization the user belong to.
     *
     * @return self
     */
