...
/**
 * SAMLServiceGetSAMLRequestRequest Class Doc Comment
 *
 * @category Class
 * @package  Zitadel\Client
 * @author   OpenAPI Generator team
 ...
 */
class SAMLServiceGetSAMLRequestRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'SAMLServiceGetSAMLRequestRequest';
    ...
    */
     ...
     * Sets samlRequestId
     *
     * @param string|null $samlRequestId ID of the SAML Request, as obtained from the redirect URL.
     *
     * @return self
     */
