...
/**
 * V2SAMLConfig Class Doc Comment
 *
 * @category Class
 * @package  Zitadel\Client
 * @author   OpenAPI Generator team
 ...
 */
class V2SAMLConfig implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'v2SAMLConfig';
    ...
    protected static $openAPITypes = [
        'metadataXml' => 'string',
        'binding' => '\Zitadel\Client\Model\V2SAMLBinding',
        'withSignedRequest' => 'bool',
        'nameIdFormat' => '\Zitadel\Client\Model\V2SAMLNameIDFormat',
    ...
    */
    ...
    public function setMetadataXml($metadataXml)
    {
        ...
        if ((!preg_match("/^(?:[A-Za-z0-9+\/]{4})*(?:[A-Za-z0-9+\/]{2}==|[A-Za-z0-9+\/]{3}=)?$/", ObjectSerializer::toString($metadataXml)))) {
            throw new \InvalidArgumentException("invalid value for \$metadataXml when calling V2SAMLConfig., must conform to the pattern /^(?:[A-Za-z0-9+\/]{4})*(?:[A-Za-z0-9+\/]{2}==|[A-Za-z0-9+\/]{3}=)?$/.");
        }
     ...
     * Gets binding
     *
     * @return \Zitadel\Client\Model\V2SAMLBinding|null
     */
     ...
     * Sets binding
     *
     * @param \Zitadel\Client\Model\V2SAMLBinding|null $binding binding
     *
     * @return self
     */
     ...
     * Gets nameIdFormat
     *
     * @return \Zitadel\Client\Model\V2SAMLNameIDFormat|null
     */
     ...
     * Sets nameIdFormat
     *
     * @param \Zitadel\Client\Model\V2SAMLNameIDFormat|null $nameIdFormat nameIdFormat
     *
     * @return self
     */
