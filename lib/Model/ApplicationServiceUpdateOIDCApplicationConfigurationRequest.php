...
/**
 * ApplicationServiceUpdateOIDCApplicationConfigurationRequest Class Doc Comment
 *
 * @category Class
 * @package  Zitadel\Client
 * @author   OpenAPI Generator team
 ...
 */
class ApplicationServiceUpdateOIDCApplicationConfigurationRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ApplicationServiceUpdateOIDCApplicationConfigurationRequest';
    ...
    */
     ...
     * Sets redirectUris
     *
     * @param string[]|null $redirectUris RedirectURIs are the allowed callback URIs for the OAuth2 / OIDC flows,  where the authorization code or tokens will be sent to.  The redirect_uri parameter in the authorization request must exactly match one of these URIs.  Any existing redirect URIs not included in this list will be removed.  If not set, the redirect URIs will not be changed.
     *
     * @return self
     */
     ...
     * Sets responseTypes
     *
     * @param \Zitadel\Client\Model\ApplicationServiceOIDCResponseType[]|null $responseTypes ResponseTypes define whether a code, id_token token or just id_token will be returned.  The response_type parameter in the authorization request must exactly match one of these values.  Any existing response types not included in this list will be removed.  If not set, the response types will not be changed.
     *
     * @return self
     */
     ...
     *
     * @param bool|null $developmentMode DevelopmentMode can be enabled for development purposes. This allows the use of  OIDC non-compliant and potentially insecure settings, such as the use of  HTTP redirect URIs or wildcard redirect URIs.  If not set, the dev mode will not be changed.
     *
     * @return self
     */
    public function setDevelopmentMode($developmentMode)
    {
        if (is_null($developmentMode)) {
            array_push($this->openAPINullablesSetToNull, 'developmentMode');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('developmentMode', $nullablesSetToNull);
            if ($index !== FALSE) {
     ...
     *
     * @param bool|null $accessTokenRoleAssertion If AccessTokenRoleAssertion is enabled, the roles of the user are added to the access token.  Ensure that the access token is a JWT token and not a bearer token. And either request the roles  by scope or enable the user role assertion on the project.  If not set, the access token role assertion will not be changed.
     *
     * @return self
     */
    public function setAccessTokenRoleAssertion($accessTokenRoleAssertion)
    {
        if (is_null($accessTokenRoleAssertion)) {
            array_push($this->openAPINullablesSetToNull, 'accessTokenRoleAssertion');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('accessTokenRoleAssertion', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
     ...
     *
     * @param bool|null $idTokenRoleAssertion If IDTokenRoleAssertion is enabled, the roles of the user are added to the id token.  Ensure that either the roles are requested by scope or enable the user role assertion on the  project.  If not set, the id token role assertion will not be changed.
     *
     * @return self
     */
    public function setIdTokenRoleAssertion($idTokenRoleAssertion)
    {
        if (is_null($idTokenRoleAssertion)) {
            array_push($this->openAPINullablesSetToNull, 'idTokenRoleAssertion');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('idTokenRoleAssertion', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
    ...
    public function setIdTokenUserinfoAssertion($idTokenUserinfoAssertion)
    {
        if (is_null($idTokenUserinfoAssertion)) {
            array_push($this->openAPINullablesSetToNull, 'idTokenUserinfoAssertion');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('idTokenUserinfoAssertion', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
     ...
     *
     * @param bool|null $skipNativeAppSuccessPage For native apps a successful login usually shows a success page with a link to open the application again.  SkipNativeAppSuccessPage can be used to skip this page and open the application directly.  If not set, the skip native app success page will not be changed.
     *
     * @return self
     */
    public function setSkipNativeAppSuccessPage($skipNativeAppSuccessPage)
    {
        if (is_null($skipNativeAppSuccessPage)) {
            array_push($this->openAPINullablesSetToNull, 'skipNativeAppSuccessPage');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('skipNativeAppSuccessPage', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
     ...
     *
     * @param string|null $backChannelLogoutUri BackChannelLogoutURI is used to notify the application about terminated sessions according  to the OIDC Back-Channel Logout (https://openid.net/specs/openid-connect-backchannel-1_0.html).  If not set, the back channel logout URI will not be changed.
     *
     * @return self
     */
