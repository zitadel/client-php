...
/**
 * V2SetHumanPhone1 Class Doc Comment
 *
 * @category Class
 * @package  Zitadel\Client
 * @author   OpenAPI Generator team
 ...
 */
class V2SetHumanPhone1 implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'v2SetHumanPhone_1';
    ...
    */
    ...
    public function setPhone($phone)
    {
        ...
        if ((mb_strlen($phone) > 200)) {
            throw new \InvalidArgumentException('invalid length for $phone when calling V2SetHumanPhone1., must be smaller than or equal to 200.');
        }
