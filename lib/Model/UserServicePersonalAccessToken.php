...
/**
 * UserServicePersonalAccessToken Class Doc Comment
 *
 * @category Class
 * @package  Zitadel\Client
 * @author   OpenAPI Generator team
 ...
 */
class UserServicePersonalAccessToken implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'UserServicePersonalAccessToken';
    ...
    */
     ...
     * Sets id
     *
     * @param string|null $id The unique identifier of the personal access token.
     *
     * @return self
     */
     ...
     * Sets userId
     *
     * @param string|null $userId The unique identifier of the user the personal access token belongs to.
     *
     * @return self
     */
     ...
     * Sets organizationId
     *
     * @param string|null $organizationId The unique identifier of the organization the personal access token belongs to.
     *
     * @return self
     */
