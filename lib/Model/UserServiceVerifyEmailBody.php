...
/**
 * UserServiceVerifyEmailBody Class Doc Comment
 *
 * @category Class
 * @package  Zitadel\Client
 * @author   OpenAPI Generator team
 ...
 */
class UserServiceVerifyEmailBody implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'UserServiceVerifyEmailBody';
    ...
    */
    ...
    public function setVerificationCode($verificationCode)
    {
        ...
        if ((mb_strlen($verificationCode) > 20)) {
            throw new \InvalidArgumentException('invalid length for $verificationCode when calling UserServiceVerifyEmailBody., must be smaller than or equal to 20.');
        }
        if ((mb_strlen($verificationCode) < 1)) {
            throw new \InvalidArgumentException('invalid length for $verificationCode when calling UserServiceVerifyEmailBody., must be bigger than or equal to 1.');
        }
