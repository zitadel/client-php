...
/**
 * ProjectServiceCreateProjectRequest Class Doc Comment
 *
 * @category Class
 * @package  Zitadel\Client
 * @author   OpenAPI Generator team
 ...
 */
class ProjectServiceCreateProjectRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ProjectServiceCreateProjectRequest';
    ...
    */
     ...
     * Sets projectId
     *
     * @param string|null $projectId ProjectID is the unique identifier of the new project. This field is optional.  If omitted, the system will generate a unique ID for you. This is the  recommended way. The generated ID will be returned in the response.
     *
     * @return self
     */
     ...
     * Sets name
     *
     * @param string|null $name Name of the project. This might be presented to users, e.g. in sign-in flows.
     *
     * @return self
     */
     ...
     *
     * @param bool|null $projectRoleAssertion ProjectRoleAssertion is a  setting that can be enabled to have role information  included in the user info endpoint.  It is also dependent on your application settings to include it in tokens and other types.
     *
     * @return self
     */
