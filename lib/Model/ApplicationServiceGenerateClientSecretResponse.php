...
/**
 * ApplicationServiceGenerateClientSecretResponse Class Doc Comment
 *
 * @category Class
 * @package  Zitadel\Client
 * @author   OpenAPI Generator team
 ...
 */
class ApplicationServiceGenerateClientSecretResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ApplicationServiceGenerateClientSecretResponse';
    ...
    */
     ...
     * Sets clientSecret
     *
     * @param string|null $clientSecret The newly generated client secret. It must be stored safely, as it will not be possible to retrieve it again.  A new client secret can be generated using this endpoint.
     *
     * @return self
     */
