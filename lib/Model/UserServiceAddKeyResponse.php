...
/**
 * UserServiceAddKeyResponse Class Doc Comment
 *
 * @category Class
 * @package  Zitadel\Client
 * @author   OpenAPI Generator team
 ...
 */
class UserServiceAddKeyResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'UserServiceAddKeyResponse';
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('keyContent', $data ?? [], null);
    }
    ...
    */
     ...
     * Sets keyId
     *
     * @param string|null $keyId The keys ID.
     *
     * @return self
     */
    ...
    {
        return $this->container['keyContent'];
    }

    /**
     * Sets keyContent
     *
     * @param string|null $keyContent The key which is usable to authenticate against the API.
     *
     * @return self
     */
    public function setKeyContent($keyContent)
    {
        if (is_null($keyContent)) {
            throw new \InvalidArgumentException('non-nullable keyContent cannot be null');
        }
        $this->container['keyContent'] = $keyContent;
