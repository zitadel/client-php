...
/**
 * BetaActionServiceExecutionSearchFilter Class Doc Comment
 *
 * @category Class
 * @package  Zitadel\Client
 * @author   OpenAPI Generator team
 ...
 */
class BetaActionServiceExecutionSearchFilter implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'BetaActionServiceExecutionSearchFilter';
    ...
    protected static $openAPITypes = [
        'executionTypeFilter' => '\Zitadel\Client\Model\BetaActionServiceExecutionTypeFilter',
        'inConditionsFilter' => '\Zitadel\Client\Model\BetaActionServiceInConditionsFilter',
        'targetFilter' => '\Zitadel\Client\Model\BetaActionServiceTargetFilter'
    ];
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['executionTypeFilter'] === null) {
            $invalidProperties[] = "'executionTypeFilter' can't be null";
        }
        if ($this->container['inConditionsFilter'] === null) {
            $invalidProperties[] = "'inConditionsFilter' can't be null";
        }
        if ($this->container['targetFilter'] === null) {
            $invalidProperties[] = "'targetFilter' can't be null";
        }
     ...
     *
     * @return \Zitadel\Client\Model\BetaActionServiceExecutionTypeFilter
     */
     ...
     *
     * @param \Zitadel\Client\Model\BetaActionServiceExecutionTypeFilter $executionTypeFilter executionTypeFilter
     *
     * @return self
     */
     ...
     *
     * @return \Zitadel\Client\Model\BetaActionServiceInConditionsFilter
     */
     ...
     *
     * @param \Zitadel\Client\Model\BetaActionServiceInConditionsFilter $inConditionsFilter inConditionsFilter
     *
     * @return self
     */
     ...
     * Gets targetFilter
     *
     * @return \Zitadel\Client\Model\BetaActionServiceTargetFilter
     */
     ...
     * Sets targetFilter
     *
     * @param \Zitadel\Client\Model\BetaActionServiceTargetFilter $targetFilter targetFilter
     *
     * @return self
     */
