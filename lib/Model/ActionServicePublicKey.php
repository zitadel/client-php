...
/**
 * ActionServicePublicKey Class Doc Comment
 *
 * @category Class
 * @package  Zitadel\Client
 * @author   OpenAPI Generator team
 ...
 */
class ActionServicePublicKey implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ActionServicePublicKey';
    ...
    */
     ...
     * Sets keyId
     *
     * @param string|null $keyId KeyID is the unique identifier of the public key.  It's also used as the `kid` field in the JWE header when the payload type is set to `PAYLOAD_TYPE_JWE`.
     *
     * @return self
     */
     ...
     * Sets active
     *
     * @param bool|null $active Active indicates whether the public key is active and used for payload encryption.  Only one public key can be active at a time.
     *
     * @return self
     */
     ...
     * Sets publicKey
     *
     * @param string|null $publicKey The public key in PEM format.
     *
     * @return self
     */
     ...
     * Sets fingerprint
     *
     * @param string|null $fingerprint Fingerprint is the fingerprint of the public key. It's prefixed with the hashing algorithm used  and base64 encoded without padding, e.g. `SHA256:STqK+Sd4qgdu+UjiwI8NBjOD6P7UqQ42EZYIdySEyTw`.  The fingerprint can be used to easily compare the public key with other sources.
     *
     * @return self
     */
