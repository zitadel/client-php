...
/**
 * BetaOrganizationServiceVerifyOrganizationDomainRequest Class Doc Comment
 *
 * @category Class
 * @package  Zitadel\Client
 * @author   OpenAPI Generator team
 ...
 */
class BetaOrganizationServiceVerifyOrganizationDomainRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'BetaOrganizationServiceVerifyOrganizationDomainRequest';
    ...
    */
     ...
     * Sets domain
     *
     * @param string|null $domain Organization Id for the Organization doman to be verified.
     *
     * @return self
     */
