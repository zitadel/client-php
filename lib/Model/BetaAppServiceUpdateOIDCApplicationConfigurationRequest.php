...
/**
 * BetaAppServiceUpdateOIDCApplicationConfigurationRequest Class Doc Comment
 *
 * @category Class
 * @package  Zitadel\Client
 * @author   OpenAPI Generator team
 ...
 */
class BetaAppServiceUpdateOIDCApplicationConfigurationRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'BetaAppServiceUpdateOIDCApplicationConfigurationRequest';
    ...
    */
    ...
    {
        if (is_null($devMode)) {
            array_push($this->openAPINullablesSetToNull, 'devMode');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('devMode', $nullablesSetToNull);
            if ($index !== FALSE) {
