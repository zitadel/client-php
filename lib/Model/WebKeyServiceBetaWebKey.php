...
/**
 * WebKeyServiceBetaWebKey Class Doc Comment
 *
 * @category Class
 * @package  Zitadel\Client
 * @author   OpenAPI Generator team
 ...
 */
class WebKeyServiceBetaWebKey implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'WebKeyServiceBetaWebKey';
    ...
    protected static $openAPITypes = [
        ...
        'changeDate' => '\DateTime',
        'state' => '\Zitadel\Client\Model\WebKeyServiceBetaState',
    ...
    */
     ...
     * Sets creationDate
     *
     * @param \DateTime|null $creationDate The timestamp of the key creation.
     *
     * @return self
     */
     ...
     * Sets changeDate
     *
     * @param \DateTime|null $changeDate The timestamp of the last change to the key (e.g. creation, activation, deactivation).
     *
     * @return self
     */
     ...
     * Gets state
     *
     * @return \Zitadel\Client\Model\WebKeyServiceBetaState|null
     */
     ...
     * Sets state
     *
     * @param \Zitadel\Client\Model\WebKeyServiceBetaState|null $state state
     *
     * @return self
     */
