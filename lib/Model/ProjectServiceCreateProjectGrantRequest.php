...
/**
 * ProjectServiceCreateProjectGrantRequest Class Doc Comment
 *
 * @category Class
 * @package  Zitadel\Client
 * @author   OpenAPI Generator team
 ...
 */
class ProjectServiceCreateProjectGrantRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ProjectServiceCreateProjectGrantRequest';
    ...
    */
     ...
     *
     * @param string|null $grantedOrganizationId GrantedOrganizationID is the unique identifier of the organization the project will be granted to.
     *
     * @return self
     */
     ...
     * Sets roleKeys
     *
     * @param string[]|null $roleKeys RoleKeys is a list of roles to be granted to the organization for self management.  The roles are identified by their keys.
     *
     * @return self
     */
