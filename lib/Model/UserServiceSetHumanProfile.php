...
/**
 * UserServiceSetHumanProfile Class Doc Comment
 *
 * @category Class
 * @package  Zitadel\Client
 * @author   OpenAPI Generator team
 ...
 */
class UserServiceSetHumanProfile implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'UserServiceSetHumanProfile';
    ...
    protected static $openAPITypes = [
        ...
        'gender' => '\Zitadel\Client\Model\UserServiceGender'
    ];
    ...
    */
    ...
    public function setGivenName($givenName)
    {
        ...
        if ((mb_strlen($givenName) > 200)) {
            throw new \InvalidArgumentException('invalid length for $givenName when calling UserServiceSetHumanProfile., must be smaller than or equal to 200.');
        }
        if ((mb_strlen($givenName) < 1)) {
            throw new \InvalidArgumentException('invalid length for $givenName when calling UserServiceSetHumanProfile., must be bigger than or equal to 1.');
        }
    ...
    public function setFamilyName($familyName)
    {
        ...
        if ((mb_strlen($familyName) > 200)) {
            throw new \InvalidArgumentException('invalid length for $familyName when calling UserServiceSetHumanProfile., must be smaller than or equal to 200.');
        }
        if ((mb_strlen($familyName) < 1)) {
            throw new \InvalidArgumentException('invalid length for $familyName when calling UserServiceSetHumanProfile., must be bigger than or equal to 1.');
        }
    ...
    public function setNickName($nickName)
    {
        ...
        if ((mb_strlen($nickName) > 200)) {
            throw new \InvalidArgumentException('invalid length for $nickName when calling UserServiceSetHumanProfile., must be smaller than or equal to 200.');
        }
    ...
    public function setDisplayName($displayName)
    {
        ...
        if ((mb_strlen($displayName) > 200)) {
            throw new \InvalidArgumentException('invalid length for $displayName when calling UserServiceSetHumanProfile., must be smaller than or equal to 200.');
        }
    ...
    public function setPreferredLanguage($preferredLanguage)
    {
        ...
        if ((mb_strlen($preferredLanguage) > 10)) {
            throw new \InvalidArgumentException('invalid length for $preferredLanguage when calling UserServiceSetHumanProfile., must be smaller than or equal to 10.');
        }
     ...
     * Gets gender
     *
     * @return \Zitadel\Client\Model\UserServiceGender|null
     */
     ...
     * Sets gender
     *
     * @param \Zitadel\Client\Model\UserServiceGender|null $gender gender
     *
     * @return self
     */
