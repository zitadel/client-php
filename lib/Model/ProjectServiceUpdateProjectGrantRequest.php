...
/**
 * ProjectServiceUpdateProjectGrantRequest Class Doc Comment
 *
 * @category Class
 * @package  Zitadel\Client
 * @author   OpenAPI Generator team
 ...
 */
class ProjectServiceUpdateProjectGrantRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ProjectServiceUpdateProjectGrantRequest';
    ...
    */
     ...
     *
     * @param string|null $grantedOrganizationId GrantedOrganizationID is the unique identifier of the organization the project was granted to.
     *
     * @return self
     */
