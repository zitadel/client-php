...
/**
 * ActionServiceAddPublicKeyRequest Class Doc Comment
 *
 * @category Class
 * @package  Zitadel\Client
 * @author   OpenAPI Generator team
 ...
 */
class ActionServiceAddPublicKeyRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ActionServiceAddPublicKeyRequest';
    ...
    */
     ...
     * Sets targetId
     *
     * @param string|null $targetId The unique identifier of the target to add the public key to.
     *
     * @return self
     */
     ...
     * Sets publicKey
     *
     * @param string|null $publicKey The public key in PEM format. It must be either an RSA or an EC public key.
     *
     * @return self
     */
