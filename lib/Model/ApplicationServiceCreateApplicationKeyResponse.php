...
/**
 * ApplicationServiceCreateApplicationKeyResponse Class Doc Comment
 *
 * @category Class
 * @package  Zitadel\Client
 * @author   OpenAPI Generator team
 ...
 */
class ApplicationServiceCreateApplicationKeyResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ApplicationServiceCreateApplicationKeyResponse';
    ...
    */
     ...
     * Sets keyId
     *
     * @param string|null $keyId The unique ID of the newly created application key.
     *
     * @return self
     */
     ...
     * Sets keyDetails
     *
     * @param string|null $keyDetails KeyDetails contains the serialized private key and additional information depending on the key type.  It must be stored safely, as it will not be possible to retrieve it again.  A new key can be generated using the CreateApplicationKey endpoint.
     *
     * @return self
     */
