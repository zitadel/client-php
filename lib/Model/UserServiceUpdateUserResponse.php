...
/**
 * UserServiceUpdateUserResponse Class Doc Comment
 *
 * @category Class
 * @package  Zitadel\Client
 * @author   OpenAPI Generator team
 ...
 */
class UserServiceUpdateUserResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'UserServiceUpdateUserResponse';
    ...
    */
     ...
     * Sets emailCode
     *
     * @param string|null $emailCode In case the email verification was set to return_code, the code will be returned
     *
     * @return self
     */
     ...
     * Sets phoneCode
     *
     * @param string|null $phoneCode In case the phone verification was set to return_code, the code will be returned
     *
     * @return self
     */
