...
/**
 * ApplicationServiceApplicationKey Class Doc Comment
 *
 * @category Class
 * @package  Zitadel\Client
 * @author   OpenAPI Generator team
 ...
 */
class ApplicationServiceApplicationKey implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ApplicationServiceApplicationKey';
    ...
    */
     ...
     * Sets keyId
     *
     * @param string|null $keyId The unique identifier of the application key.
     *
     * @return self
     */
     ...
     * Sets applicationId
     *
     * @param string|null $applicationId The identifier of the application this key belongs to.
     *
     * @return self
     */
     ...
     * Sets projectId
     *
     * @param string|null $projectId The identifier of the project this application belongs to.
     *
     * @return self
     */
     ...
     * Sets organizationId
     *
     * @param string|null $organizationId The identifier of the organization this application belongs to.
     *
     * @return self
     */
