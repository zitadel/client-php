...
/**
 * V2StartIdentityProviderIntentRequest Class Doc Comment
 *
 * @category Class
 * @package  Zitadel\Client
 * @author   OpenAPI Generator team
 ...
 */
class V2StartIdentityProviderIntentRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'v2StartIdentityProviderIntentRequest';
    ...
    protected static $openAPITypes = [
        'idpId' => 'string',
        'urls' => '\Zitadel\Client\Model\V2RedirectURLs',
        'ldap' => '\Zitadel\Client\Model\V2LDAPCredentials'
    ];
    ...
    */
    ...
    public function setIdpId($idpId)
    {
        ...
        if ((mb_strlen($idpId) > 200)) {
            throw new \InvalidArgumentException('invalid length for $idpId when calling V2StartIdentityProviderIntentRequest., must be smaller than or equal to 200.');
        }
        if ((mb_strlen($idpId) < 1)) {
            throw new \InvalidArgumentException('invalid length for $idpId when calling V2StartIdentityProviderIntentRequest., must be bigger than or equal to 1.');
        }
     ...
     * Gets urls
     *
     * @return \Zitadel\Client\Model\V2RedirectURLs|null
     */
     ...
     * Sets urls
     *
     * @param \Zitadel\Client\Model\V2RedirectURLs|null $urls urls
     *
     * @return self
     */
     ...
     * Gets ldap
     *
     * @return \Zitadel\Client\Model\V2LDAPCredentials|null
     */
     ...
     * Sets ldap
     *
     * @param \Zitadel\Client\Model\V2LDAPCredentials|null $ldap ldap
     *
     * @return self
     */
