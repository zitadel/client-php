...
/**
 * V2EmailQuery Class Doc Comment
 *
 * @category Class
 ...
 */
class V2EmailQuery implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'v2EmailQuery';
    ...
    */
    ...
    public function setEmailAddress($emailAddress)
    {
        ...
        if ((mb_strlen($emailAddress) > 200)) {
            throw new \InvalidArgumentException('invalid length for $emailAddress when calling V2EmailQuery., must be smaller than or equal to 200.');
        }
