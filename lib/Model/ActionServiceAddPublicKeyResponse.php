...
/**
 * ActionServiceAddPublicKeyResponse Class Doc Comment
 *
 * @category Class
 * @package  Zitadel\Client
 * @author   OpenAPI Generator team
 ...
 */
class ActionServiceAddPublicKeyResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ActionServiceAddPublicKeyResponse';
    ...
    */
     ...
     * Sets keyId
     *
     * @param string|null $keyId The KeyID is the unique identifier of the newly added public key.  The ID is also used a `kid` in the JWT header for payload encryption.  This allows the target to identify the correct key to use for decryption.
     *
     * @return self
     */
