...
/**
 * SessionServiceSetSessionRequest Class Doc Comment
 *
 * @category Class
 * @package  Zitadel\Client
 * @author   OpenAPI Generator team
 ...
 */
class SessionServiceSetSessionRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'SessionServiceSetSessionRequest';
    ...
    protected static $openAPITypes = [
        'sessionToken' => 'string',
        'checks' => '\Zitadel\Client\Model\SessionServiceChecks',
        'metadata' => 'array<string,string>',
        'challenges' => '\Zitadel\Client\Model\SessionServiceRequestChallenges',
        'lifetime' => 'string'
    ];
    ...
    */
    ...
    public function setSessionToken($sessionToken)
    {
        ...
        if ((mb_strlen($sessionToken) > 200)) {
            throw new \InvalidArgumentException('invalid length for $sessionToken when calling SessionServiceSetSessionRequest., must be smaller than or equal to 200.');
        }
        if ((mb_strlen($sessionToken) < 1)) {
            throw new \InvalidArgumentException('invalid length for $sessionToken when calling SessionServiceSetSessionRequest., must be bigger than or equal to 1.');
        }
     ...
     * Gets checks
     *
     * @return \Zitadel\Client\Model\SessionServiceChecks|null
     */
     ...
     * Sets checks
     *
     * @param \Zitadel\Client\Model\SessionServiceChecks|null $checks checks
     *
     * @return self
     */
     ...
     * Gets challenges
     *
     * @return \Zitadel\Client\Model\SessionServiceRequestChallenges|null
     */
     ...
     * Sets challenges
     *
     * @param \Zitadel\Client\Model\SessionServiceRequestChallenges|null $challenges challenges
     *
     * @return self
     */
