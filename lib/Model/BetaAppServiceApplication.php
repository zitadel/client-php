...
/**
 * BetaAppServiceApplication Class Doc Comment
 *
 * @category Class
 * @package  Zitadel\Client
 * @author   OpenAPI Generator team
 ...
 */
class BetaAppServiceApplication implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'BetaAppServiceApplication';
    ...
    protected static $openAPITypes = [
        ...
        'changeDate' => '\DateTime',
        'state' => '\Zitadel\Client\Model\BetaAppServiceAppState',
        'name' => 'string',
        'apiConfig' => '\Zitadel\Client\Model\BetaAppServiceAPIConfig',
        'oidcConfig' => '\Zitadel\Client\Model\BetaAppServiceOIDCConfig',
        'samlConfig' => '\Zitadel\Client\Model\BetaAppServiceSAMLConfig'
    ];
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['apiConfig'] === null) {
            $invalidProperties[] = "'apiConfig' can't be null";
        }
        if ($this->container['oidcConfig'] === null) {
            $invalidProperties[] = "'oidcConfig' can't be null";
        }
        if ($this->container['samlConfig'] === null) {
            $invalidProperties[] = "'samlConfig' can't be null";
        }
     ...
     * Sets state
     *
     * @param \Zitadel\Client\Model\BetaAppServiceAppState|null $state state
     *
     * @return self
     */
     ...
     * Gets apiConfig
     *
     * @return \Zitadel\Client\Model\BetaAppServiceAPIConfig
     */
     ...
     * Sets apiConfig
     *
     * @param \Zitadel\Client\Model\BetaAppServiceAPIConfig $apiConfig apiConfig
     *
     * @return self
     */
     ...
     * Gets oidcConfig
     *
     * @return \Zitadel\Client\Model\BetaAppServiceOIDCConfig
     */
     ...
     * Sets oidcConfig
     *
     * @param \Zitadel\Client\Model\BetaAppServiceOIDCConfig $oidcConfig oidcConfig
     *
     * @return self
     */
     ...
     * Gets samlConfig
     *
     * @return \Zitadel\Client\Model\BetaAppServiceSAMLConfig
     */
     ...
     * Sets samlConfig
     *
     * @param \Zitadel\Client\Model\BetaAppServiceSAMLConfig $samlConfig samlConfig
     *
     * @return self
     */
