...
/**
 * BetaActionServiceUpdateTargetResponse Class Doc Comment
 *
 * @category Class
 * @package  Zitadel\Client
 * @author   OpenAPI Generator team
 ...
 */
class BetaActionServiceUpdateTargetResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'BetaActionServiceUpdateTargetResponse';
    ...
    */
    ...
    public function setSigningKey($signingKey)
    {
        if (is_null($signingKey)) {
            array_push($this->openAPINullablesSetToNull, 'signingKey');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('signingKey', $nullablesSetToNull);
            if ($index !== FALSE) {
