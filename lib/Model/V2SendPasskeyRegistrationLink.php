...
/**
 * V2SendPasskeyRegistrationLink Class Doc Comment
 *
 * @category Class
 * @package  Zitadel\Client
 * @author   OpenAPI Generator team
 ...
 */
class V2SendPasskeyRegistrationLink implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'v2SendPasskeyRegistrationLink';
    ...
    */
    ...
    public function setUrlTemplate($urlTemplate)
    {
        ...
        if ((mb_strlen($urlTemplate) > 200)) {
            throw new \InvalidArgumentException('invalid length for $urlTemplate when calling V2SendPasskeyRegistrationLink., must be smaller than or equal to 200.');
        }
        if ((mb_strlen($urlTemplate) < 1)) {
            throw new \InvalidArgumentException('invalid length for $urlTemplate when calling V2SendPasskeyRegistrationLink., must be bigger than or equal to 1.');
        }
