...
/**
 * ApplicationServiceCreateApplicationKeyRequest Class Doc Comment
 *
 * @category Class
 * @package  Zitadel\Client
 * @author   OpenAPI Generator team
 ...
 */
class ApplicationServiceCreateApplicationKeyRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ApplicationServiceCreateApplicationKeyRequest';
    ...
    */
     ...
     * Sets applicationId
     *
     * @param string|null $applicationId The ID of the application the key will be created for.
     *
     * @return self
     */
