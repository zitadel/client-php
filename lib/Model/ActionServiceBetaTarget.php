...
/**
 * ActionServiceBetaTarget Class Doc Comment
 *
 * @category Class
 * @package  Zitadel\Client
 * @author   OpenAPI Generator team
 ...
 */
class ActionServiceBetaTarget implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ActionServiceBetaTarget';
    ...
    */
     ...
     * Sets creationDate
     *
     * @param \DateTime|null $creationDate The timestamp of the target creation.
     *
     * @return self
     */
     ...
     * Sets changeDate
     *
     * @param \DateTime|null $changeDate The timestamp of the last change to the target (e.g. creation, activation, deactivation).
     *
     * @return self
     */
