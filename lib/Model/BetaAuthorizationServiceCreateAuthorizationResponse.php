...
/**
 * BetaAuthorizationServiceCreateAuthorizationResponse Class Doc Comment
 *
 * @category Class
 * @package  Zitadel\Client
 * @author   OpenAPI Generator team
 ...
 */
class BetaAuthorizationServiceCreateAuthorizationResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'BetaAuthorizationServiceCreateAuthorizationResponse';
    ...
    */
     ...
     * Sets id
     *
     * @param string|null $id ID is the unique identifier of the newly created authorization.
     *
     * @return self
     */
