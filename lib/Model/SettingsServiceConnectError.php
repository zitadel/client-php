...
class SettingsServiceConnectError implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        'code' => 'string',
        'message' => 'string',
        'details' => '\Zitadel\Client\Model\SettingsServiceAny[]'
    ];
    ...
    */
     ...
     * Sets details
     *
     * @param \Zitadel\Client\Model\SettingsServiceAny[]|null $details A list of messages that carry the error details. There is no limit on the number of messages.
     *
     * @return self
     */
