...
/**
 * UserServiceCreateUserResponse Class Doc Comment
 *
 * @category Class
 * @package  Zitadel\Client
 * @author   OpenAPI Generator team
 ...
 */
class UserServiceCreateUserResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'UserServiceCreateUserResponse';
    ...
    */
     ...
     * Sets id
     *
     * @param string|null $id The unique identifier of the newly created user.
     *
     * @return self
     */
     ...
     * Sets emailCode
     *
     * @param string|null $emailCode The email verification code if it was requested by setting the email verification to return_code.
     *
     * @return self
     */
     ...
     * Sets phoneCode
     *
     * @param string|null $phoneCode The phone verification code if it was requested by setting the phone verification to return_code.
     *
     * @return self
     */
