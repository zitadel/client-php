...
/**
 * BetaOrganizationServiceDetails Class Doc Comment
 *
 * @category Class
 * @package  Zitadel\Client
 * @author   OpenAPI Generator team
 ...
 */
class BetaOrganizationServiceDetails implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'BetaOrganizationServiceDetails';
    ...
    */
     ...
     * Sets sequence
     *
     * @param mixed|null $sequence sequence represents the order of events. It's always counting   on read: the sequence of the last event reduced by the projection   on manipulation: the timestamp of the event(s) added by the manipulation
     *
     * @return self
     */
     ...
     * Sets resourceOwner
     *
     * @param string|null $resourceOwner resource_owner is the organization or instance_id an object belongs to
     *
     * @return self
     */
