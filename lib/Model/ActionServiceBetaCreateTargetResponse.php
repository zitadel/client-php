...
/**
 * ActionServiceBetaCreateTargetResponse Class Doc Comment
 *
 * @category Class
 * @package  Zitadel\Client
 * @author   OpenAPI Generator team
 ...
 */
class ActionServiceBetaCreateTargetResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ActionServiceBetaCreateTargetResponse';
    ...
    */
     ...
     * Sets id
     *
     * @param string|null $id The unique identifier of the newly created target.
     *
     * @return self
     */
