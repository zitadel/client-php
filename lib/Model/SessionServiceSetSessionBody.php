...
/**
 * SessionServiceSetSessionBody Class Doc Comment
 *
 * @category Class
 * @package  Zitadel\Client
 * @author   OpenAPI Generator team
 ...
 */
class SessionServiceSetSessionBody implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'SessionServiceSetSessionBody';
    ...
    protected static $openAPITypes = [
        'sessionToken' => 'string',
        'checks' => '\Zitadel\Client\Model\V2Checks',
        'metadata' => 'array<string,string>',
        'challenges' => '\Zitadel\Client\Model\V2RequestChallenges',
        'lifetime' => 'string'
    ];
    ...
    */
    ...
    public function setSessionToken($sessionToken)
    {
        ...
        if ((mb_strlen($sessionToken) > 200)) {
            throw new \InvalidArgumentException('invalid length for $sessionToken when calling SessionServiceSetSessionBody., must be smaller than or equal to 200.');
        }
        if ((mb_strlen($sessionToken) < 1)) {
            throw new \InvalidArgumentException('invalid length for $sessionToken when calling SessionServiceSetSessionBody., must be bigger than or equal to 1.');
        }
     ...
     * Gets checks
     *
     * @return \Zitadel\Client\Model\V2Checks|null
     */
     ...
     * Sets checks
     *
     * @param \Zitadel\Client\Model\V2Checks|null $checks checks
     *
     * @return self
     */
     ...
     * Gets challenges
     *
     * @return \Zitadel\Client\Model\V2RequestChallenges|null
     */
     ...
     * Sets challenges
     *
     * @param \Zitadel\Client\Model\V2RequestChallenges|null $challenges challenges
     *
     * @return self
     */
