...
/**
 * BetaAuthorizationServiceUser Class Doc Comment
 *
 * @category Class
 * @package  Zitadel\Client
 * @author   OpenAPI Generator team
 ...
 */
class BetaAuthorizationServiceUser implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'BetaAuthorizationServiceUser';
    ...
    */
     ...
     * Sets id
     *
     * @param string|null $id ID represents the ID of the user who was granted the authorization.
     *
     * @return self
     */
     ...
     *
     * @param string|null $preferredLoginName PreferredLoginName represents the preferred login name of the granted user.
     *
     * @return self
     */
     ...
     * Sets displayName
     *
     * @param string|null $displayName DisplayName represents the public display name of the granted user.
     *
     * @return self
     */
     ...
     * Sets avatarUrl
     *
     * @param string|null $avatarUrl AvatarURL is the URL to the user's public avatar image.
     *
     * @return self
     */
     ...
     * Sets organizationId
     *
     * @param string|null $organizationId The organization the user belong to.  This does not have to correspond with the authorizations organization.
     *
     * @return self
     */
