...
/**
 * V2AuthorizationError Class Doc Comment
 *
 * @category Class
 * @package  Zitadel\Client
 * @author   OpenAPI Generator team
 ...
 */
class V2AuthorizationError implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'v2AuthorizationError';
    ...
    protected static $openAPITypes = [
        'error' => '\Zitadel\Client\Model\V2ErrorReason',
    ...
    */
     ...
     * Gets error
     *
     * @return \Zitadel\Client\Model\V2ErrorReason|null
     */
     ...
     * Sets error
     *
     * @param \Zitadel\Client\Model\V2ErrorReason|null $error error
     *
     * @return self
     */
