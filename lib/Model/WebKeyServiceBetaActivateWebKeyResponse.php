...
/**
 * WebKeyServiceBetaActivateWebKeyResponse Class Doc Comment
 *
 * @category Class
 * @package  Zitadel\Client
 * @author   OpenAPI Generator team
 ...
 */
class WebKeyServiceBetaActivateWebKeyResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'WebKeyServiceBetaActivateWebKeyResponse';
    ...
    */
     ...
     * Sets changeDate
     *
     * @param \DateTime|null $changeDate The timestamp of the activation of the key.
     *
     * @return self
     */
