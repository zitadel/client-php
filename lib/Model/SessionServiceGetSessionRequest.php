...
/**
 * SessionServiceGetSessionRequest Class Doc Comment
 *
 * @category Class
 * @package  Zitadel\Client
 * @author   OpenAPI Generator team
 ...
 */
class SessionServiceGetSessionRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'SessionServiceGetSessionRequest';
    ...
    */
     ...
     * Sets sessionId
     *
     * @param string|null $sessionId The unique identifier of the session to be retrieved.
     *
     * @return self
     */
