...
/**
 * ProjectServiceUpdateProjectRequest Class Doc Comment
 *
 * @category Class
 * @package  Zitadel\Client
 * @author   OpenAPI Generator team
 ...
 */
class ProjectServiceUpdateProjectRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ProjectServiceUpdateProjectRequest';
    ...
    */
     ...
     * Sets projectId
     *
     * @param string|null $projectId ProjectID is the unique identifier of the project to be updated.
     *
     * @return self
     */
     ...
     * Sets name
     *
     * @param string|null $name Name is used to update the name of the project. This field is optional.  If omitted, the name will remain unchanged.
     *
     * @return self
     */
     ...
     *
     * @param bool|null $projectRoleAssertion ProjectRoleAssertion is a setting that can be enabled to have role information  included in the user info endpoint.  It is also dependent on your application settings to include it in tokens and other types.  If omitted, the setting will remain unchanged.
     *
     * @return self
     */
     ...
     *
     * @param bool|null $authorizationRequired AuthorizationRequired is a boolean flag that can be enabled to check if a user has  a role of this project assigned when logging into an application of this project.  If omitted, the setting will remain unchanged.
     *
     * @return self
     */
    public function setAuthorizationRequired($authorizationRequired)
    {
        if (is_null($authorizationRequired)) {
            array_push($this->openAPINullablesSetToNull, 'authorizationRequired');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('authorizationRequired', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
     ...
     *
     * @param bool|null $projectAccessRequired ProjectAccessRequired is a boolean flag that can be enabled to check if the organization  of the user has a grant to this project.  If omitted, the setting will remain unchanged.
     *
     * @return self
     */
    public function setProjectAccessRequired($projectAccessRequired)
    {
        if (is_null($projectAccessRequired)) {
            array_push($this->openAPINullablesSetToNull, 'projectAccessRequired');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('projectAccessRequired', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
