...
/**
 * BetaProjectServiceUpdateProjectGrantRequest Class Doc Comment
 *
 * @category Class
 * @package  Zitadel\Client
 * @author   OpenAPI Generator team
 ...
 */
class BetaProjectServiceUpdateProjectGrantRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'BetaProjectServiceUpdateProjectGrantRequest';
    ...
    */
     ...
     * Sets roleKeys
     *
     * @param string[]|null $roleKeys Keys of the role available for the project grant.
     *
     * @return self
     */
