...
/**
 * ProjectServiceProjectGrant Class Doc Comment
 *
 * @category Class
 * @package  Zitadel\Client
 * @author   OpenAPI Generator team
 ...
 */
class ProjectServiceProjectGrant implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ProjectServiceProjectGrant';
    ...
    protected static $openAPITypes = [
        ...
        'projectId' => 'string',
        'projectName' => 'string',
        'state' => '\Zitadel\Client\Model\ProjectServiceProjectGrantState'
    ];
    ...
    */
     ...
     * Sets organizationId
     *
     * @param string|null $organizationId The unique identifier of the organization which granted the project to the granted_organization_id.
     *
     * @return self
     */
    ...
    public function setGrantedOrganizationName($grantedOrganizationName)
    {
        if (is_null($grantedOrganizationName)) {
            throw new \InvalidArgumentException('non-nullable grantedOrganizationName cannot be null');
        }
     ...
     *
     * @param string[]|null $grantedRoleKeys The roles granted to the organization for self-management of the project.
     *
     * @return self
     */
     ...
     * Sets projectId
     *
     * @param string|null $projectId The ID of the granted project.
     *
     * @return self
     */
     ...
     * Sets projectName
     *
     * @param string|null $projectName The name of the granted project.
     *
     * @return self
     */
     ...
     * Gets state
     *
     * @return \Zitadel\Client\Model\ProjectServiceProjectGrantState|null
     */
     ...
     * Sets state
     *
     * @param \Zitadel\Client\Model\ProjectServiceProjectGrantState|null $state state
     *
     * @return self
     */
