...
/**
 * UserServiceAddPersonalAccessTokenResponse Class Doc Comment
 *
 * @category Class
 * @package  Zitadel\Client
 * @author   OpenAPI Generator team
 ...
 */
class UserServiceAddPersonalAccessTokenResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'UserServiceAddPersonalAccessTokenResponse';
    ...
    */
     ...
     * Sets tokenId
     *
     * @param string|null $tokenId The tokens ID.
     *
     * @return self
     */
     ...
     * Sets token
     *
     * @param string|null $token The personal access token that can be used to authenticate against the API
     *
     * @return self
     */
