...
/**
 * UserServiceRemoveIDPLinkRequest Class Doc Comment
 *
 * @category Class
 * @package  Zitadel\Client
 * @author   OpenAPI Generator team
 ...
 */
class UserServiceRemoveIDPLinkRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'UserServiceRemoveIDPLinkRequest';
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('linkedUserId', $data ?? [], null);
    }
    ...
    */
    ...
    {
        return $this->container['linkedUserId'];
    }
    ...
    {
        if (is_null($linkedUserId)) {
            throw new \InvalidArgumentException('non-nullable linkedUserId cannot be null');
        }
        $this->container['linkedUserId'] = $linkedUserId;
