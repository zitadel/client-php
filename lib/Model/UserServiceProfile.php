...
/**
 * UserServiceProfile Class Doc Comment
 *
 * @category Class
 * @package  Zitadel\Client
 * @author   OpenAPI Generator team
 ...
 */
class UserServiceProfile implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'UserServiceProfile';
    ...
    */
     ...
     * Sets givenName
     *
     * @param string|null $givenName The given name is the first name of the user.  For example, it can be used to personalize notifications and login UIs.
     *
     * @return self
     */
     ...
     * Sets familyName
     *
     * @param string|null $familyName The family name is the last name of the user.  For example, it can be used to personalize user interfaces and notifications.
     *
     * @return self
     */
     ...
     * Sets nickName
     *
     * @param string|null $nickName The nick name is the users short name.  For example, it can be used to personalize user interfaces and notifications.
     *
     * @return self
     */
     ...
     * Sets displayName
     *
     * @param string|null $displayName The display name is how a user should primarily be displayed in lists.  It can also for example be used to personalize user interfaces and notifications.
     *
     * @return self
     */
