...
/**
 * V2AzureADConfig Class Doc Comment
 *
 * @category Class
 * @package  Zitadel\Client
 * @author   OpenAPI Generator team
 ...
 */
class V2AzureADConfig implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'v2AzureADConfig';
    ...
    protected static $openAPITypes = [
        'clientId' => 'string',
        'tenant' => '\Zitadel\Client\Model\V2AzureADTenant',
        'emailVerified' => 'bool',
        'scopes' => 'string[]'
    ];
    ...
    */
     ...
     * Gets tenant
     *
     * @return \Zitadel\Client\Model\V2AzureADTenant|null
     */
     ...
     * Sets tenant
     *
     * @param \Zitadel\Client\Model\V2AzureADTenant|null $tenant tenant
     *
     * @return self
     */
