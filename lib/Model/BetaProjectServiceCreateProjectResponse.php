...
/**
 * BetaProjectServiceCreateProjectResponse Class Doc Comment
 *
 * @category Class
 * @package  Zitadel\Client
 * @author   OpenAPI Generator team
 ...
 */
class BetaProjectServiceCreateProjectResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'BetaProjectServiceCreateProjectResponse';
    ...
    */
     ...
     * Sets id
     *
     * @param string|null $id The unique identifier of the newly created project.
     *
     * @return self
     */
