...
/**
 * UserServiceKey Class Doc Comment
 *
 * @category Class
 * @package  Zitadel\Client
 * @author   OpenAPI Generator team
 ...
 */
class UserServiceKey implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'UserServiceKey';
    ...
    */
     ...
     * Sets userId
     *
     * @param string|null $userId The unique identifier of the user the key belongs to.
     *
     * @return self
     */
     ...
     * Sets organizationId
     *
     * @param string|null $organizationId The unique identifier of the organization the key belongs to.
     *
     * @return self
     */
