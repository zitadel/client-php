...
/**
 * ProjectServiceProjectRole Class Doc Comment
 *
 * @category Class
 * @package  Zitadel\Client
 * @author   OpenAPI Generator team
 ...
 */
class ProjectServiceProjectRole implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ProjectServiceProjectRole';
    ...
    */
     ...
     * Sets projectId
     *
     * @param string|null $projectId ProjectID is the ID of the project the role belongs to.
     *
     * @return self
     */
     ...
     * Sets key
     *
     * @param string|null $key Key of the project role. The key identifies the role. It's the only relevant attribute for ZITADEL and  will be used for authorization checks and as claim in tokens and user info responses.
     *
     * @return self
     */
